...
const PokemonForm: FunctionComponent<Props> = ({ pokemon, isEditForm }) => {
  //console.log(`Mode édition : ${isEditForm}`);
  ...
  const selectType = (
    ...
    if (checked) {
      // Si l'utilisateur coche un type, on l'ajoute à la liste des pokémons
      const newTypes: string[] = form.types.value.concat([type]);
      newField = { value: newTypes };
    } else {
      // Si l'utilisateur décoche un type, on le supprime de la liste des pokémons
      ...
      <div className="row">
        <div className="col s12 m8 offset-m2">
          <div className="card hoverable">
            ...
            >
              <i
                onClick={!isEditForm ? backToList : deletePokemon}
                className="material-icons"
              >
                {!isEditForm ? "highlight_off" : "delete"}
              </i>
            </span>
